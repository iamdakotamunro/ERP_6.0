<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RefundsMoney_RemarkForm.aspx.cs" Inherits="ERP.UI.Web.RefundsMoney.RefundsMoney_RemarkForm" %>
...
<body>
    ...
    <asp:HiddenField ID="HF_ApplyId" runat="server" />
    <div>
