<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" Inherits="ERP.UI.Web.CostCompanyClassAw" Codebehind="CostCompanyClass.aspx.cs" %>
    ...
    <table class="PanelArea">
        <tr>
            <td style="width: 380px; vertical-align: top;">
                <rad:RadTreeView ID="TV_CompanyClass" runat="server"  
                    UseEmbeddedScripts="false" Height="460px" Width="360px" AutoPostBack="true" CausesValidation="false"
                    OnNodeClick="TV_CompanyClass_NodeClick">
                </rad:RadTreeView>
            </td>
...
<rad:RadAjaxManager ID="RAM" runat="server" 
    ...
    <AjaxSettings>
        <rad:AjaxSetting AjaxControlID="LB_Inster">
            ...
            <UpdatedControls>
                <rad:AjaxUpdatedControl ControlID="CompanyClassPanel" LoadingPanelID="loading">
        ...
        <rad:AjaxSetting AjaxControlID="LB_Delete">
            <UpdatedControls>
                <rad:AjaxUpdatedControl ControlID="TV_CompanyClass" LoadingPanelID="loading">
                </rad:AjaxUpdatedControl>
            </UpdatedControls>
            <UpdatedControls>
                <rad:AjaxUpdatedControl ControlID="CompanyClassPanel" LoadingPanelID="loading">
