<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditFirstGoods.aspx.cs" Inherits="ERP.UI.Web.Windows.EditFirstGoods" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="background-color: #F2F2F2;">
            <div class="tab">
                <a id="A_BasicInfo" href="javascript:void(0);" onclick="ChangeTab(this,'BasicInfo')" class="now">基本信息</a>
            ...
            <div id="BasicInfo" style="padding: 10px 0 10px 0;">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_GoodsName" runat="server" Width="300px" CssClass="Check" onblur="SetLabel()"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddl_GoodsClass" runat="server" CssClass="Check"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            上(下)架：<asp:CheckBox ID="ckb_IsOnShelf" runat="server" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <MasterTableView DataKeyNames="ID">
                        ...
                        <Columns>
                            ...
                            <rad:GridTemplateColumn HeaderText="全选">
                                <ItemTemplate>
                                    <asp:CheckBox ID="ckb_All" runat="server" Checked='<%# Eval("IsAll") %>' onclick="checkPurchasingGroup(this)" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <rad:GridTemplateColumn HeaderText="直营">
                                <ItemTemplate>
                                    <asp:CheckBox ID="ckb_IsDirect" runat="server" Checked='<%# Eval("IsDirect") %>' onclick="checkPurchasingGroup(this)" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </rad:GridTemplateColumn>
                            <rad:GridTemplateColumn HeaderText="加盟">
                                <ItemTemplate>
                                    <asp:CheckBox ID="ckb_IsJoin" runat="server" Checked='<%# Eval("IsJoin") %>' onclick="checkPurchasingGroup(this)" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </rad:GridTemplateColumn>
                            <rad:GridTemplateColumn HeaderText="联盟">
                                <ItemTemplate>
                                    <asp:CheckBox ID="ckb_IsAlliance" runat="server" Checked='<%# Eval("IsAlliance") %>' onclick="checkPurchasingGroup(this)" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </rad:GridTemplateColumn>
        ...
        <div style="padding-top: 10px;">
            <table style="width: 100%;">
                <tr id="GoodsAuditStateMemo" runat="server">
                    <td style="text-align: right; width: 100px;">审核说明：</td>
                    <td>
                        <asp:TextBox ID="txt_GoodsAuditStateMemo" runat="server" TextMode="MultiLine" Width="99%" Height="50px" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
