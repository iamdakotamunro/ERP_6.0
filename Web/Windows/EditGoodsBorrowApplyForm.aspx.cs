...
namespace ERP.UI.Web.Windows
{
    ...
    /// 编辑/重送借入申请
    /// </summary>
    public partial class EditGoodsBorrowApplyForm : System.Web.UI.Page
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            var storageRecordInfo = _storageRecordDao.GetStorageRecord(StockId);
            if (storageRecordInfo == null) return;
            if (!string.IsNullOrEmpty(Request.QueryString["IsAgain"]) && Request.QueryString["IsAgain"] == "1")
            {
                if (storageRecordInfo.StockState != (int)StorageRecordState.Refuse)
                {
