<%@ Page Language="C#" AutoEventWireup="True" Inherits="ERP.UI.Web.Windows.ShowPurasingClewForm" CodeBehind="ShowPurasingClewForm.aspx.cs" %>
...
<body scroll="no">
    ...
    <table class="PanelArea">
        ...
        <tr>
            <td align="center">
                <rad:RadComboBox ID="RCB_Clew" runat="server" Width="380px" Height="120px" AllowCustomText="true" 
                ...
                <asp:requiredfieldvalidator id="RFVClew" runat="server" errormessage="处理意见不能为空！" text="*" controltovalidate="RCB_Clew">
                </asp:requiredfieldvalidator>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="3" style="height: 30px;">
                <Ibt:ImageButtonControl ID="LB_Clew" OnClick="Button_UpdateClew" SkinType="Affirm" runat="server"></Ibt:ImageButtonControl>
                &nbsp;&nbsp;
                <Ibt:ImageButtonControl ID="LB_Cancel" OnClientClick="return CancelWindow()" SkinType="Cancel" runat="server"></Ibt:ImageButtonControl>
            </td>
        </tr>
    </table>
