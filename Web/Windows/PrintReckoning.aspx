<%@ Page Language="C#" AutoEventWireup="true" Inherits="ERP.UI.Web.Windows.PrintReckoning"
    CodeBehind="PrintReckoning.aspx.cs" %>
<%@Register Src="../UserControl/ImageButtonControl.ascx" TagName="ImageButtonControl" TagPrefix="Ibt" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>审核单位往来帐单据</title>
...
<body scroll="no">
    ...
    <asp:Panel ID="noAuditing" runat="server">
        ...
        <table class="PanelArea">
            ...
            <tr>
                <td class="PromptFromRowTitle">
                    <asp:Literal ID="Literal4" runat="server"></asp:Literal>金额：
                </td>
                <td class="AreaEditFromRowInfo">
                    <asp:TextBox ID="Lit_AccountReceivable2" runat="server"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="AreaEditFromRowInfo">
                    <asp:TextBox ID="Lit_Poundage2" runat="server"></asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="ReduceIncomeGroup"
                        ControlToValidate="Lit_Poundage2" Text="*" ErrorMessage="请输入正数！" ValidationExpression="[0-9]{0,}\.?[0-9]{0,}$"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="PromptFromRowTitle">
