<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintGoodsStockInDetail.aspx.cs"
    Inherits="ERP.UI.Web.Windows.PrintGoodsStockInDetail" %>
    ...
    <table width="100%">
        <tr>
            <td colspan="4" style="font-size: 14px; text-align: center; height: 22px;">
                <%= "入库单 ： "+GetFilialeName(StorageRecordInfo.FilialeId)+"-"+EnumAttribute.GetKeyName((StorageType)StorageRecordInfo.StockType)%>
            </td>
        </tr>
        <tr>
            <td class="tdTitle">
        ...
        <tr>
            ...
            <td class="tdContent" runat="server" id="td_TotalPrice">
    ...
    <rad:RadGrid ID="RGGoods" runat="server" SkinID="Common" AllowPaging="False" OnNeedDataSource="RgGoodsNeedDataSource"
        ...
        <MasterTableView CommandItemDisplay="None">
            <Columns>
                ...
                <rad:GridBoundColumn DataField="ApprovalNO" HeaderText="批文号" UniqueName="ApprovalNO">
                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </rad:GridBoundColumn>
            </Columns>
