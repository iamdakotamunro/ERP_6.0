<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGoodsLendApplyForm.aspx.cs" Inherits="ERP.UI.Web.Windows.EditGoodsLendApplyForm" %>
        ...
        <rad:RadScriptBlock ID="RSB" runat="server">
            ...
            <script language="javascript" type="text/javascript">
                ...
                function Total() {
                    ...
                    var aTd = mstview.get_element().getElementsByTagName("tr");//[4].innerText;
                    var totalNumber = 0;
                    var totalPrice = 0;
                ...
                <tr>
                    <td>
                        ...
                        <rad:RadGrid ID="RG_Goods" OnNeedDataSource="RgGoods_NeedDataSource" AllowPaging="false"
                           OnDeleteCommand="RgGoods_DeleteCommand" runat="server" OnItemDataBound="RgGoodsItemDataBound">
                            <ClientSettings>
                            ...
                            <MasterTableView DataKeyNames="GoodsId,RealGoodsId,UnitPrice,ShelfType" CommandItemDisplay="None">
                                ...
                                <Columns>
                                    ...
                                    <rad:GridTemplateColumn HeaderText="返还数">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="TB_Quantity" Text='<%# Math.Abs(Convert.ToDouble(Eval("Quantity"))) %>'  onblur="HiddenIbtnQuantityOut(this);"
