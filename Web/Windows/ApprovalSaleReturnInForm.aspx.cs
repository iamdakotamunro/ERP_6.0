...
namespace ERP.UI.Web.Windows
{
    ...
    /// 审批销售退货入库
    /// </summary>
    public partial class ApprovalSaleReturnInForm : System.Web.UI.Page
    {
...
new StorageRecordDao(GlobalConfig.DB.FromType.Write);
        ...
        protected void btnApproval_Click(object sender, EventArgs e)
        {
            ...
            string errorMsg = "";
            var isValid = _storageManager.ApproveSellReturnStockIn(stockId, lbl_ThirdCompanyID.Text, personnel.PersonnelId, personnel.RealName, out errorMsg);
            if(isValid)
            {
        ...
        private void BindData(Guid stockId)
        {
            ...
            if (isShop)
            {
                ...
                if (shop != null)
                {
                    lbl_ThirdCompanyID.Text = shop.Name;
                }
            }
            else
            {
