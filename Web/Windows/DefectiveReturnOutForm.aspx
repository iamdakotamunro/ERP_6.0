<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefectiveReturnOutForm.aspx.cs" Inherits="ERP.UI.Web.Windows.DefectiveReturnOutForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel class="StagePanel" runat="server">
                ...
                <tr>
                    ...
                    <td class="AreaRowInfo">
                        <rad:RadComboBox ID="RCB_HostingFilialeAuth" runat="server" AccessKey="T" ShowToggleImage="True" AutoPostBack="True"
                            DataTextField="HostingFilialeName" DataValueField="HostingFilialeId" OnSelectedIndexChanged="RcbFilialeAuthOnSelectedIndexChanged" Width="250px">
                        </rad:RadComboBox>
                    </td>
                </tr>
                <%--<tr>
                    ...
                    <td class="AreaRowInfo" colspan="3">
                        <rad:RadComboBox ID="RCB_CompanyId" runat="server" AccessKey="T" MarkFirstMatch="True" 
                            DataTextField="CompanyName" DataValueField="CompanyId" Width="250px"
                            Height="200px" >
                        </rad:RadComboBox>
                    </td>
            ...
            <rad:RadGrid ID="RGGoods" AllowPaging="false" runat="server" SkinID="Common" Height="266px"
                OnNeedDataSource="RgGoods_NeedDataSource" OnDeleteCommand="RgGoods_DeleteCommand" AllowMultiRowSelection="true">
                <ClientSettings>
                    <Resizing AllowColumnResize="True"></Resizing>
                    <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                    <ClientMessages DragToResize="调整大小" />
                </ClientSettings>
                <MasterTableView ClientDataKeyNames="RealGoodsId,ThirdCompanyID" DataKeyNames="RealGoodsId,UnitPrice,GoodsId,ThirdCompanyID">
                    <CommandItemTemplate>
                        <asp:LinkButton ID="lbtnSelectGoods" OnClientClick="return SelectGoods();" runat="server">
                         ...
                         <asp:LinkButton ID="LinkButtonDelete" runat="server" CommandName="RebindGrid" OnClick="DeleteGoods_Click">
                             <asp:Image ID="Delete" runat="server" ImageAlign="AbsMiddle" SkinID="DeleteImageButton" />删除商品
                         </asp:LinkButton>&nbsp;&nbsp;&nbsp;
