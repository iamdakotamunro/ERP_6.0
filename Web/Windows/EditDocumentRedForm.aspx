<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDocumentRedForm.aspx.cs" Inherits="ERP.UI.Web.Windows.EditDocumentRedForm" %>
            ...
            <div class="StagePanel">
                ...
                <table class="PanelArea">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox7" runat="server"  SkinID="LongInput"></asp:TextBox>
                        </td>
                        <td>
                            收货公司：
                        </td>
                        <td>
                              <asp:TextBox ID="TextBox8" runat="server"  SkinID="LongInput"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>录单时间：
                        ...
                        <td>
                            <asp:TextBox ID="TextBox2" runat="server"  SkinID="LongInput" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>经 办 人：
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                             <asp:TextBox ID="TextBox5" runat="server" Width="87%" MaxLength="100" Height="30px"  TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>备注说明：
