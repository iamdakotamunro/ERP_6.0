<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGoodsLendApplyReturnForm.aspx.cs" Inherits="ERP.UI.Web.Windows.EditGoodsLendApplyReturnForm" %>
            ...
            <table class="PanelArea">
                ...
                <tr>
                    ...
                    <rad:RadComboBox ID="RCB_StorageAuth" runat="server" AccessKey="T" ShowToggleImage="True"
                        DataTextField="StorageTypeName" DataValueField="StorageType" Width="121px" Enabled="False">
                    </rad:RadComboBox>
                    </td>
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lbTitle" Text="借出返还单" Style="font-weight: bold; font-size: 16px;" runat="server"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        <rad:RadGrid ID="RG_GoodsBack" OnNeedDataSource="RgGoodsBack_NeedDataSource" OnItemDataBound="RgGoodsBack_OnItemDataBound"
                            OnItemCommand="RG_GoodsBack_OnItemCommand" AllowPaging="False" 
                            runat="server">
                            <ClientSettings>
