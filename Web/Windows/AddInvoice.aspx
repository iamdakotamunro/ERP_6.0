<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddInvoice.aspx.cs" Inherits="ERP.UI.Web.Windows.AddInvoice" %>
    ...
    <asp:Panel ID="Panel_AddInvoice" runat="server">
        <table>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="TB_Address" runat="server" Width="375px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TB_No"
                    Text="*" ErrorMessage="发票号码必须为数字！" ValidationExpression="\d*"></asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TB_No"
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="TB_Sum" runat="server"></asp:TextBox>
                    <asp:RegularExpressionValidator ID="REVCost" runat="server" ControlToValidate="TB_Sum"
                    Text="*" ErrorMessage="发票总额必须为数字！" ValidationExpression="\d*(\.\d*){0,1}"></asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TB_Sum"
            ...
            <tr>
                ...
                <td colspan="3">
                        <rad:RadDateTimePicker ID="RDP_AddInvoiceTime" runat="server" SkinID="Common" >
                        <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" CellVAlign="Top" ViewSelectorText="x"></Calendar>

                        <TimeView CellSpacing="-1" Culture="Chinese (People's Republic of China)"></TimeView>
