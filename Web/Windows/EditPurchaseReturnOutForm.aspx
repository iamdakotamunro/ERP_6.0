<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPurchaseReturnOutForm.aspx.cs" Inherits="ERP.UI.Web.Windows.EditPurchaseReturnOutForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel runat="server">
            <div class="StagePanel">
                <table class="PanelArea">
                    ...
                    <tr>
                        <td class="AreaRowTitle">入库单据号：</td>
                        <td class="AreaRowInfo" colspan="3">
                            <rad:RadComboBox ID="RCB_CreateNo" runat="server" AccessKey="T" ShowToggleImage="True"
                                DataTextField="TradeCode" DataValueField="StockId" Width="250px"
                                OnSelectedIndexChanged="RcbCreateNoOnSelectedIndexChanged" AutoPostBack="true"
                                OnItemsRequested="RcbCreateNoItemsRequested" AllowCustomText="True" EnableLoadOnDemand="True">
                            </rad:RadComboBox>
                        </td>
                    </tr>
        ...
        <div id="GoodsPanel" style="background-color: #FFFFFF; width: 100%; height: 200px; left: 0px; position: absolute; top: 0px; z-index: -1; visibility: hidden">
            ...
            <rad:RadGrid runat="server" ID="RGSelectGoods" AutoGenerateColumns="true" MasterTableView-CommandItemDisplay="None"
                ...
                AllowPaging="false" OnColumnCreated="RGSelectGoods_ColumnCreated" OnItemDataBound="RGSelectGoods_ItemDataBound">
                <ClientSettings>
                    <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                </ClientSettings>
