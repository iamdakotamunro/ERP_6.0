<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InnerPurchaseForm.aspx.cs" Inherits="ERP.UI.Web.Windows.InnerPurchaseForm" %>
            ...
            <asp:Table ID="ControlToolsTab" runat="server" BorderWidth="0" CellPadding="0" CellSpacing="0"
                ...
                <asp:TableRow>
                    <asp:TableCell CssClass="ControlTools">
                        ...
                        <ibt:imagebuttoncontrol_1 id="LB_Cancel" runat="server" onclientclick="return CancelWindow()"
                            skintype="Cancel" text="取消"></ibt:imagebuttoncontrol_1>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
