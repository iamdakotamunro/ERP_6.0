<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMergeSplitForm.aspx.cs"
    Inherits="ERP.UI.Web.Windows.AddMergeSplitForm" %>
...
<body>
    ...
    <div style="padding: 10px; padding-top: 20px;">
        ...
        <br />
        <fieldset>
            <legend style="font-style: oblique; font-weight: bold; font-size: 14px;">拆分组合商品</legend>
            <br />
        ...
        <img src="../App_Themes/default/Images/next.png" alt="目标拆分商品列表" style="margin-left: 55px;" />
        <fieldset style="margin-left: 0px;">
            <legend style="font-style: oblique; font-weight: bold; font-size: 14px;">目标拆分商品列表</legend>
            <br />
            <table width="650px;" style="background-color: #f7f7f7; border: solid 1px #cccccc;
                border-spacing: 0px; margin-left: 10px;">
                <tr>
            ...
            <table width="100%">
                <tr>
                    <td style="text-align: right;">
                        <asp:Button ID="btnSplit" runat="server" Text="拆分" OnClick="BtnSplit_Click" Width="80" />
                    </td>
