...
namespace ERP.UI.Web.SubsidyPayment
{
    ...
    public partial class Check : BasePage
    {
        ...
        public void LoadStateData()
        {
            ...
            di.Add(0, "");
            di.Add((int)SubsidyPaymentStatusEnum.PendingFinanceCheck, "待财务审核");
        ...
        protected void RG_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            SubsidyPaymentInfo_SeachModel seachModel = new SubsidyPaymentInfo_SeachModel()
            {
                ...
                listStatus = new List<int>() { (int)SubsidyPaymentStatusEnum.PendingFinanceCheck, (int)SubsidyPaymentStatusEnum.Rejected, }
            };
