<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RefundRemittanceForm.aspx.cs" Inherits="ERP.UI.Web.ThirdParty.RefundRemittanceForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <div runat="server" id="DivAuditingPanel">
            <table>
                ...
                <tr>
                    <td class="ShortFromRowTitle">退款金额：
                    </td>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <asp:Button ID="BtRemittance" runat="server" Text="退款完成" OnClick="BtRemittanceClick" CssClass="pass" />
                        </td>
                    </tr>
            </table>
        </div>
