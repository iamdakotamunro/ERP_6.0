<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubsidyAuditForm.aspx.cs" Inherits="ERP.UI.Web.ThirdParty.SubsidyAuditForm" %>
        ...
        <div runat="server" id="DivAuditingPanel">
            <table>
                ...
                <tr>
                    ...
                    <td class="AreaEditFromRowInfo">
                        <asp:TextBox ID="TbAccountsNo" runat="server" Width="200" Enabled="False"></asp:TextBox>
                    </td>
                </tr>
                <tr>
