<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostReport_InvoiceAccept.aspx.cs" Inherits="ERP.UI.Web.CostReport.CostReport_InvoiceAccept" %>
...
<body>
    <form id="form1" runat="server">
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: right;">受理说明：</td>
                <td colspan="3">
            ...
            <tr>
                <td colspan="4" style="text-align: center;">
                    <asp:Button ID="btn_Pass" runat="server" Text="通&nbsp;&nbsp;过" OnClientClick="return CheckEmpty('Pass');" OnClick="btn_Pass_Click" />&nbsp;&nbsp;
        ...
        <script type="text/javascript">
            ...
            function CheckEmpty(obj) {
                ...
                if (txtAuditingMemo.val().length === 0 && obj === "NoPass") {
