<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostReport_ReceivablesPayment.aspx.cs" Inherits="ERP.UI.Web.CostReport.CostReport_ReceivablesPayment" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: right;">
                    <asp:Literal ID="lit_Amount" runat="server">付款</asp:Literal>金额：</td>
                <td colspan="3">
                    <asp:TextBox ID="txt_Amount" runat="server" Width="250px" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td style="text-align: right;">
                    <b>
                        <asp:Literal ID="lit_AuditingMemo" runat="server" Text="付款"></asp:Literal></b>说明：
                </td>
                <td colspan="3">
            ...
            <tr>
                <td style="text-align: right;">退回说明：
                </td>
                <td colspan="3">
                    <asp:TextBox ID="txt_BackMemo" runat="server" TextMode="MultiLine" Width="99%" Height="50px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="text-align: center;">
                    <asp:Button ID="btn_Pay" runat="server" Text="付款" OnClientClick="return CheckEmpty();" OnClick="btn_Pay_Click" />&nbsp;&nbsp;
                    <asp:Button ID="btn_Save" runat="server" Text="保存" OnClientClick="return CheckEmpty();" OnClick="btn_Save_Click" />&nbsp;&nbsp;
                    <asp:Button ID="btn_Back" runat="server" Text="退回" OnClientClick="return CheckBackMemo('GoBack');" OnClick="btn_Back_Click" />
                    <asp:Button ID="btn_BackToPre" runat="server" Text="退回上一关" Visible="False" OnClientClick="return CheckBackMemo('GoBack');" OnClick="btn_BackToPre_Click" />
                </td>
            </tr>
        </table>
        <asp:HiddenField ID="Hid_InvoiceTitleFilialeId" runat="server" />
        <script src="../JavaScript/jquery.js"></script>
        <script src="../JavaScript/telerik.js"></script>
        <script src="../JavaScript/tool.js"></script>
        <script type="text/javascript">
            $(function () {
                PayBankAccount();//显示结算账号提示
            ...
            function PayBankAccount() {
                var ddlPayBankAccount = $("#ddl_PayBankAccount");
                var title = ddlPayBankAccount.find("option:selected").text();
                ddlPayBankAccount.attr("title", title);
            }
            ...
            //验证退回说明
            function CheckBackMemo(obj) {
                var txtBackMemo = $("#txt_BackMemo");
                if (txtBackMemo.val().length === 0 && obj === "GoBack") {
                    txtBackMemo.css("border-color", "red");
                    return false;
                } else {
                    txtBackMemo.css("border-color", "");
                    return true;
                }
            }
